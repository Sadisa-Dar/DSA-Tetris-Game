...
public class GamePanel extends JPanel {
    ...
    private int score = 0;
    private int level = 1;
    private static final int LEVEL_UP_SCORE = 1500;
    ...
    public GamePanel() {
        ...
        backgroundImage = new ImageIcon(
            "D:\\BS-CS\\BS-CS-3rd-Semester\\DSA by Dr. Syed Qamar Askari Shah\\Milestone-3\\Hard Mode\\src\\images\\background.jpg"
        ).getImage();

        topLeftImage = new ImageIcon(
            "D:\\BS-CS\\BS-CS-3rd-Semester\\DSA by Dr. Syed Qamar Askari Shah\\Milestone-3\\Hard Mode\\src\\images\\Tetris_logo.png"
        ).getImage();
    ...
    // ---------------- SCORE + LEVEL ----------------
    private void updateScoreAndLevel(int cleared) {
        int points;
        if (cleared == 1){
            points = 300;
        } 
        ...
        gravityTimer.setDelay(Math.max(120, 550 - (level - 1) * 50));
    }
    ...
    public void spawnBlock() {
        ...
        // Center horizontally
        int shapeWidth = newBlock.getShape()[0].length;
        int startX = (COLS - shapeWidth) / 2;
        newBlock.setPosition(startX, 0);
        ...
        // Game Over Check
        if (!canMoveWithShape(newBlock.getShape(), newBlock.getX(), newBlock.getY())) {
            gameOver = true;
